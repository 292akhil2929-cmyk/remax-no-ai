...
const themes = [
  {
    ...
    subtitle: 'Your Brand - Navy & Deep Red',
    primary: '#001a4d',
    accent: '#8B0000',
    background: '#FFFFFF',
    foreground: '#000000',
    secondary: '#F5F5F5',
    description: 'Bold navy blue primary with deep blood red accents. Matches your RE/MAX ZAM brand identity perfectly. Professional and commanding.',
  },
  {
    id: 2,
    name: 'RE/MAX Premium Dark',
    subtitle: 'Your Brand - Navy & Deep Red on Gray',
    primary: '#001a4d',
    accent: '#8B0000',
    background: '#F8F8F8',
    foreground: '#000000',
    secondary: '#EFEFEF',
    description: 'Navy and deep blood red on light gray background. High contrast for readability with luxury positioning.',
  },
  {
    id: 3,
    ...
    foreground: '#1A1A1A',
    secondary: '#F9F9F9',
    description: 'Softer navy with deep blood red. Extremely clean and modern. Perfect for investment-focused positioning.',
  },
  {
    id: 4,
    ...
    foreground: '#0A0A0A',
    secondary: '#F2F2F2',
    description: 'Deep navy primary with deep blood red. Sophisticated and premium. Strong trust signals.',
  },
  {
    id: 5,
    name: 'RE/MAX Dynamic',
    ...
    foreground: '#000000',
    secondary: '#F0F0F0',
    description: 'Slightly lighter navy with deep blood red. High energy and modern. Strong call-to-action presence.',
  },
  {
    id: 6,
    name: 'RE/MAX Luxury',
    ...
    foreground: '#0D0D0D',
    secondary: '#F7F7F7',
    description: 'Very dark navy with deep blood red. Luxurious feel. Premium real estate positioning.',
  },
];
