...
const themes = [
  {
    ...
    subtitle: 'Your Brand - Navy & Gold CTAs',
    primary: '#001a4d',
    accent: '#D4944F',
    background: '#FFFFFF',
    foreground: '#000000',
    secondary: '#F5F5F5',
    description: 'Bold navy blue with elegant gold for large buttons. Deep red used in badges/text. Premium luxury feel perfect for big panels.',
  },
  {
    id: 2,
    name: 'RE/MAX Premium Dark',
    subtitle: 'Your Brand - Navy & Gold on Gray',
    primary: '#001a4d',
    accent: '#D4944F',
    background: '#F8F8F8',
    foreground: '#000000',
    secondary: '#EFEFEF',
    description: 'Navy with warm gold CTAs on light gray background. Deep red accents in smaller elements. High luxury positioning.',
  },
  {
    id: 3,
    name: 'RE/MAX Clean White',
    subtitle: 'Your Brand - Minimalist Gold',
    primary: '#0d3b70',
    accent: '#E5B857',
    background: '#FFFFFF',
    foreground: '#1A1A1A',
    secondary: '#F9F9F9',
    description: 'Softer navy with bright gold for visibility. Clean modern look. Deep red in badges/featured tags.',
  },
  {
    id: 4,
    name: 'RE/MAX Sophisticated',
    subtitle: 'Your Brand - Navy & Warm Gold',
    primary: '#001a4d',
    accent: '#C99A4F',
    background: '#FAFAFA',
    foreground: '#0A0A0A',
    secondary: '#F2F2F2',
    description: 'Deep navy primary with warm gold CTAs. Sophisticated and premium. Deep red used for text highlights.',
  },
  {
    id: 5,
    name: 'RE/MAX Dynamic',
    subtitle: 'Your Brand - Navy & Vibrant Gold',
    primary: '#002d5e',
    accent: '#F5A623',
    background: '#FFFFFF',
    foreground: '#000000',
    secondary: '#F0F0F0',
    description: 'Slightly lighter navy with vibrant gold buttons. High energy and modern. Strong visibility on large CTAs.',
  },
  {
    id: 6,
    name: 'RE/MAX Luxury',
    subtitle: 'Your Brand - Deep Navy & Gold',
    primary: '#0a1e3f',
    accent: '#D4944F',
    background: '#FCFCFC',
    foreground: '#0D0D0D',
    secondary: '#F7F7F7',
    description: 'Very dark navy with elegant gold buttons. Most premium feel. Deep red in featured/badge elements.',
  },
];
