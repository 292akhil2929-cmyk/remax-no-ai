...
import { ArrowRight, Home, TrendingUp, Globe } from 'lucide-react';
      ...
      <div className="relative w-full z-10 px-4 sm:px-6 lg:px-8 py-12 lg:py-0">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          >
            ...
            >
              Get the Highest<br className="hidden sm:block" /> Price. Fast<br className="hidden sm:block" />
            ...
            >
              Reach 145,000+ RE/MAX agents globally. Professional marketing. Transparent process. Sell with confidence.
            </motion.p>
            ...
            >
              ...
              <Button
                ...
                asChild
              >
                <Link to="/contact">Free Market Valuation</Link>
              </Button>
            </motion.div>
            ...
            >
              {['✓ 145K+ Global Network', '✓ Avg 15% Above Market', '✓ 30-60 Days'].map(label => (
          ...
          >
            {[
              { icon: TrendingUp, label: 'Sell Price', value: 'Negotiable' },
              { icon: Home, label: 'Listed By', value: 'RE/MAX' },
              { icon: Globe, label: 'Buyer Reach', value: '145K+ Agents' },
            ].map((stat, idx) => {
